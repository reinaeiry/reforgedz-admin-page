 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(U,j){var K=U.length;U.push(j);e:for(;0<K;){var se=K-1>>>1,fe=U[se];if(0<r(fe,j))U[se]=j,U[K]=fe,K=se;else break e}}function n(U){return U.length===0?null:U[0]}function i(U){if(U.length===0)return null;var j=U[0],K=U.pop();if(K!==j){U[0]=K;e:for(var se=0,fe=U.length,ke=fe>>>1;se<ke;){var Z=2*(se+1)-1,le=U[Z],xe=Z+1,_e=U[xe];if(0>r(le,K))xe<fe&&0>r(_e,le)?(U[se]=_e,U[xe]=K,se=xe):(U[se]=le,U[Z]=K,se=Z);else if(xe<fe&&0>r(_e,K))U[se]=_e,U[xe]=K,se=xe;else break e}}return j}function r(U,j){var K=U.sortIndex-j.sortIndex;return K!==0?K:U.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();t.unstable_now=function(){return a.now()-o}}var l=[],u=[],f=1,d=null,h=3,m=!1,_=!1,y=!1,p=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(U){for(var j=n(u);j!==null;){if(j.callback===null)i(u);else if(j.startTime<=U)i(u),j.sortIndex=j.expirationTime,e(l,j);else break;j=n(u)}}function S(U){if(y=!1,v(U),!_)if(n(l)!==null)_=!0,q(P);else{var j=n(u);j!==null&&oe(S,j.startTime-U)}}function P(U,j){_=!1,y&&(y=!1,c(F),F=-1),m=!0;var K=h;try{for(v(j),d=n(l);d!==null&&(!(d.expirationTime>j)||U&&!R());){var se=d.callback;if(typeof se=="function"){d.callback=null,h=d.priorityLevel;var fe=se(d.expirationTime<=j);j=t.unstable_now(),typeof fe=="function"?d.callback=fe:d===n(l)&&i(l),v(j)}else i(l);d=n(l)}if(d!==null)var ke=!0;else{var Z=n(u);Z!==null&&oe(S,Z.startTime-j),ke=!1}return ke}finally{d=null,h=K,m=!1}}var b=!1,T=null,F=-1,ie=5,x=-1;function R(){return!(t.unstable_now()-x<ie)}function te(){if(T!==null){var U=t.unstable_now();x=U;var j=!0;try{j=T(!0,U)}finally{j?ue():(b=!1,T=null)}}else b=!1}var ue;if(typeof g=="function")ue=function(){g(te)};else if(typeof MessageChannel<"u"){var I=new MessageChannel,Q=I.port2;I.port1.onmessage=te,ue=function(){Q.postMessage(null)}}else ue=function(){p(te,0)};function q(U){T=U,b||(b=!0,ue())}function oe(U,j){F=p(function(){U(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(U){U.callback=null},t.unstable_continueExecution=function(){_||m||(_=!0,q(P))},t.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ie=0<U?Math.floor(1e3/U):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(U){switch(h){case 1:case 2:case 3:var j=3;break;default:j=h}var K=h;h=j;try{return U()}finally{h=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(U,j){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var K=h;h=U;try{return j()}finally{h=K}},t.unstable_scheduleCallback=function(U,j,K){var se=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?se+K:se):K=se,U){case 1:var fe=-1;break;case 2:fe=250;break;case 5:fe=1073741823;break;case 4:fe=1e4;break;default:fe=5e3}return fe=K+fe,U={id:f++,callback:j,priorityLevel:U,startTime:K,expirationTime:fe,sortIndex:-1},K>se?(U.sortIndex=K,e(u,U),n(l)===null&&U===n(u)&&(y?(c(F),F=-1):y=!0,oe(S,K-se))):(U.sortIndex=fe,e(l,U),_||m||(_=!0,q(P))),U},t.unstable_shouldYield=R,t.unstable_wrapCallback=function(U){var j=h;return function(){var K=h;h=j;try{return U.apply(this,arguments)}finally{h=K}}}})(yg);_g.exports=yg;var O0=_g.exports;/**
 * @license React
...
`)+`
`+g);const S=v+c+a,P=v+g+o,b=Fm(r,r.VERTEX_SHADER,S),T=Fm(r,r.FRAGMENT_SHADER,P);r.attachShader(p,b),r.attachShader(p,T),n.index0AttributeName!==void 0?r.bindAttribLocation(p,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(p,0,"position"),r.linkProgram(p);function F(te){if(t.debug.checkShaderErrors){const ue=r.getProgramInfoLog(p).trim(),I=r.getShaderInfoLog(b).trim(),Q=r.getShaderInfoLog(T).trim();let q=!0,oe=!0;if(r.getProgramParameter(p,r.LINK_STATUS)===!1)if(q=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,p,b,T);else{const U=Om(r,b,"vertex"),j=Om(r,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(p,r.VALIDATE_STATUS)+`
